...
;;
;; Tests functions are the end of the file.
;;
...
;;
;; Alternative insertion sort implementation.
;;
...
;; test-data is a list of all the test cases
  ...
  (test 
   ...
   (lambda (pair)
     (let* ([n (first pair)]
       ...
       (and (= n (first (num-denom r)))
            (= d (second (num-denom r)))))))) 
